...
mysql -u root -p${MYSQL_ROOT_PASSWORD} -e "CHANGE MASTER TO MASTER_HOST='primary_db', MASTER_USER='repl', MASTER_PASSWORD='password', MASTER_LOG_FILE='${log_file}', MASTER_LOG_POS=${pos}"
